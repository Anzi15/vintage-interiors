...
const CartPage = () => {
  const [cartItems] = useState(JSON.parse(localStorage.getItem("cart-items")));
  ...
  <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10">
    <div className="grid grid-cols-12">
      <div className="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8 lg:py-24 w-full max-xl:max-w-3xl max-xl:mx-auto">
        ...
        <div className="flex flex-col md:flex-row min-[500px]:flex-row min-[500px]:items-center gap-5 py-6  border-b border-gray-200 group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 w-full md:w-[80%]">
            <div className="md:col-span-2">
              <div className="flex flex-col  md:items-center gap-3 md:justify-left justify-center ">
