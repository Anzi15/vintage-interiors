...
const AdminLayout = () => {
  ...
  return (
    <>
      {logedIn ? <div className="flex min-h-screen">
      ...
      </div> : <div className="h-screen w-screen flex items-center justify-center flex-col gap-6">
        <h1 className="text-3xl">Please Log in to continue</h1>
        <img src={eyeGif} alt="ghostIllustration" className="h-[20rem] my-4 select-none" draggable={false} />
